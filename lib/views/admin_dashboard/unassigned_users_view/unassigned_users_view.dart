...
class UnassignedUsersView extends StatelessWidget {
  const UnassignedUsersView({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<NotificationsProvider>(
      create: (_) => NotificationsProvider(),
      child: _UnassignedUsersViewContent(),
    );
  }
}

class _UnassignedUsersViewContent extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
