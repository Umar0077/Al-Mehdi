...
import 'package:al_mehdi_online_school/providers/admin/profile_screen_provider.dart';
...
import 'package:al_mehdi_online_school/views/admin_dashboard/active_class_view.dart';
import 'package:al_mehdi_online_school/views/admin_dashboard/fees_status_view.dart';
...
import 'package:al_mehdi_online_school/views/admin_dashboard/total_users_view.dart';
import 'package:al_mehdi_online_school/views/admin_dashboard/unassigned_users_view/unassigned_users_view.dart';
...
import 'sidebar_and bottom_tabs_views/settings_view.dart';
      ...
      builder: (context, mainProvider, homeProvider, _) {
        ...
        if (selectedIndex == 0 && homeProvider.mainContentScreen != null) {
          switch (homeProvider.mainContentScreen) {
            case 'activeClasses':
              mainContent = ActiveClassView();
              break;
            case 'totalUsers':
              mainContent = TotalUsersView();
              break;
            case 'unassignedUsers':
              mainContent = UnassignedUsersView();
              break;
            case 'feesStatus':
              mainContent = FeesStatusView();
              break;
            default:
        ...
        builder: (context, provider, _) {
          ...
          if (provider.mainContentScreen == null) {
            ...
            switch (provider.mainContentScreen) {
              case 'activeClasses':
                return ActiveClassView();
              case 'totalUsers':
                return TotalUsersView();
              case 'unassignedUsers':
                return UnassignedUsersView();
              case 'feesStatus':
                return FeesStatusView();
              default:
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const ActiveClassView(),
                    ),
                  );
                },
                child: _infoCard(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const TotalUsersView(),
                        ),
                      );
                    },
                    child: _infoCard(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => UnassignedUsersView(),
                        ),
                      );
                    },
                    child: _infoCard(
              ...
              actions: [
                ...
                FutureBuilder<Map<String, dynamic>?>(
                  future: FirebaseFirestore.instance
                      ...
                      .get()
                      .then(
                        (q) => q.docs.isNotEmpty ? q.docs.first.data() : null,
                      ),
                ...
                IconButton(
                  ...
                  onPressed: () {
                    AdminSettingsProvider().showLogoutConfirmationDialog(
                      context,
                    );
                  },
                ),
                      ...
                      InkWell(
                        ...
                        onTap:
                            () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const FeesStatusView(),
                              ),
                            ),
                        child: SizedBox(
                          width: (screenWidth - 48) / 2,
