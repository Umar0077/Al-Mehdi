...
import '../../../services/teachers/optimized_chat_service.dart';
...
class OptimizedChatConversation extends StatefulWidget {
  ...
  @override
  State<OptimizedChatConversation> createState() =>
      _OptimizedChatConversationState();
}
...
class _OptimizedChatConversationState extends State<OptimizedChatConversation> {
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text('Online', style: TextStyle(fontSize: 12, color: appGreen)),
            ],
          ),
        ],
      ),
  ...
  Widget _buildMessagesList() {
    return StreamBuilder<QuerySnapshot>(
      stream: OptimizedChatService.getMessages(
        currentUserId!,
        widget.chat['studentId'] ?? widget.chat['teacherId'],
      ),
          ...
          if (isCurrentUser) ...[
            ...
            CircleAvatar(
              backgroundImage: NetworkImage(
                'https://i.pravatar.cc/100?u=$currentUserId',
              ),
              radius: 16,
            ),
          ],
