...
class _NotificationDebugViewState extends State<NotificationDebugView> {
  ...
  Future<void> _runCrossPlatformTest() async {
    ...
    try {
      final results =
          await NotificationTestService.testCrossPlatformNotifications();
      setState(() {
  ...
  Future<void> _testSelfNotification() async {
    ...
    try {
      ...
      bool success = false;
      try {
        success = await NotificationTestService.testNotificationToUser(
          user.uid,
          'teachers',
        );
      } catch (e) {
  ...
  Widget _buildStatsCard() {
    ...
    final platformStats =
        _stats!['platformDistribution'] as Map<String, dynamic>? ?? {};
  ...
  Widget _buildTestResultsCard() {
    ...
    final details =
        _testResults!['details'] as List<Map<String, dynamic>>? ?? [];
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '✅ Successful: ${_testResults!['successfulTests']}',
              style: const TextStyle(color: Colors.green),
            ),
            Text(
              '❌ Failed: ${_testResults!['failedTests']}',
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      title: Text(
                        '${detail['recipient']} (${detail['recipientType']})',
                      ),
                      subtitle:
                          detail['error'] != null
                              ? Text(
