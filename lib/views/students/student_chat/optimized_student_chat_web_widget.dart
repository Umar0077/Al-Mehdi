...
class OptimizedStudentChatWebWidget extends StatefulWidget {
  ...
  @override
  State<OptimizedStudentChatWebWidget> createState() =>
      _OptimizedStudentChatWebWidgetState();
}

class _OptimizedStudentChatWebWidgetState
    extends State<OptimizedStudentChatWebWidget> {
  ...
  void _sendMessageFast() async {
    ...
    final provider = Provider.of<StudentChatWebProvider>(
      context,
      listen: false,
    );
