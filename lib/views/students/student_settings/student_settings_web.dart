...
import 'package:al_mehdi_online_school/views/students/student_notifications/student_notifications.dart';
import 'package:al_mehdi_online_school/views/students/student_settings/widgets.dart';
...
class StudentSettingsWebView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<StudentSettingsWebProvider>(
      ...
      child: Consumer<StudentSettingsWebProvider>(
