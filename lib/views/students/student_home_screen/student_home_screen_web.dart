import 'package:al_mehdi_online_school/components/students/student_sidebar.dart';
import 'package:al_mehdi_online_school/components/teachers/chats.dart'
    as teacher_chat;
        ...
        builder: (context, provider, _) {
          final List<Widget> screens = [
            _StudentHomeContent(
              ...
              onTapRecentConversation:
                  provider.assignedTeacherId != null
                      ? () => provider.navigateToChatTab()
                      : null,
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  flex: 3,
                  child:
                      provider.showChat && provider.chatData != null
                          ? Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Row(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    final activeClasses =
                                        snapshot.data!.docs.where((doc) {
                                          ...
                                          final joinWindowStart = classDateTime
                                              ?.subtract(
                                                const Duration(minutes: 5),
                                              );
                                          final joinWindowEnd = classDateTime
                                              ?.add(
                                      ...
                                      builder: (context, chatSnapshot) {
                                        ...
                                        final chatDataMap =
                                            chatRoom.data()
                                                as Map<String, dynamic>;
                                        final lastMessage =
                                            chatDataMap['lastMessage'] ??
                                            'Click to start chatting';
                                        final lastMessageTime =
                                            chatDataMap['lastMessageTime']
                                                as Timestamp?;
                                        String teacherName =
                                            chatDataMap['teacherName'] ?? '';
