...
class TeacherChatScreenWeb extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => TeacherChatWebProvider()
          ...
          return Scaffold(
            ...
            body: Row(
              children: [
                            ...
                            : provider.students.isEmpty
                                ...
                                : ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      final chatRoomId =
                                          (teacherId != null && student['id'] != null)
                                      ...
                                      return StreamBuilder<QuerySnapshot>(
                                        stream: chatRoomId != null && teacherId != null
                                        ...
                                        builder: (context, unreadSnapshot) {
                                          ...
                                          return StreamBuilder<QuerySnapshot>(
                                            stream: FirebaseFirestore.instance
                                                ...
                                                .where('participants', arrayContains: student['id'])
                                            ...
                                            builder: (context, chatSnapshot) {
                                              ...
                                              return ChatListTile(
                                                ...
                                                message: lastMessage,
                                                time: timeText,
                                                selected: provider.selectedChatIndex == index,
                                                unreadCount: unreadCount,
                                                onTap: () => provider.selectChat(index, student['id']),
                                              );
                                            },
                                          );
                                        },
                ...
                Expanded(
                  child: provider.selectedChatIndex == null
                      ? const Center(
                          child: Text(
                      ...
                      : provider.students.isEmpty
                          ...
                          : provider.selectedChatIndex! >= provider.students.length
                              ? const Center(child: Text('Student not found'))
                              : OptimizedTeacherChatWebWidget(
                                  chat: {
                                    'avatar': provider.students[provider.selectedChatIndex!]['avatar'],
                                    'name': provider.students[provider.selectedChatIndex!]['name'],
                                    'online': provider.students[provider.selectedChatIndex!]['online'] ?? true,
                                    'studentId': provider.students[provider.selectedChatIndex!]['id'],
                                    'fcmTokens': provider.students[provider.selectedChatIndex!]['fcmTokens'],
                                  },
                                ),
                ),
              ],
