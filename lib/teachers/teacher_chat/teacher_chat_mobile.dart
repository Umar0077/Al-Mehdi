...
import 'teacher_chat_mobile_provider.dart';
                    ...
                    : provider.students.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final studentProfilePicture = student['profilePictureUrl'] ?? '';
                              final List<dynamic> fcm_token = student['fcmTokens'] != null ? List<dynamic>.from(student['fcmTokens']) : [];
                              ...
                              return StreamBuilder<QuerySnapshot>(
                                ...
                                builder: (context, chatSnapshot) {
                                  ...
                                  final chatRoomId = (teacherId != null)
                                      ? ChatService.getChatRoomId(teacherId, studentId)
                                      : null;
                                  return StreamBuilder<QuerySnapshot>(
                                    ...
                                    builder: (context, unreadSnapshot) {
                                      ...
                                      return ChatListTile(
                                        avatar: studentProfilePicture, // Will be empty string if no profile picture
                                        name: studentName,
                                        message: lastMessage,
                                        time: timeText,
                                        selected: false,
