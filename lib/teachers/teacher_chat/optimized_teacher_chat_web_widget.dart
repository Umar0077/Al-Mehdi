...
import 'teacher_chat_web_provider.dart';
...
class OptimizedTeacherChatWebWidget extends StatefulWidget {
  ...
  @override
  State<OptimizedTeacherChatWebWidget> createState() => _OptimizedTeacherChatWebWidgetState();
}

class _OptimizedTeacherChatWebWidgetState extends State<OptimizedTeacherChatWebWidget> {
  ...
  void _sendMessageFast() async {
    ...
    final studentId = widget.chat['studentId'];
    final provider = Provider.of<TeacherChatWebProvider>(context, listen: false);
