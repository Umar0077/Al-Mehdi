...
import 'teacher_settings_web_provider.dart';
...
class TeacherSettingsScreenWeb extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<TeacherSettingsWebProvider>(
      ...
      child: Consumer<TeacherSettingsWebProvider>(builder: (context, provider, _) {
        return Scaffold(
  ...
  Widget _buildPreferenceCard(BuildContext context, TeacherSettingsWebProvider provider) {
  ...
  Widget _buildAccountCard(BuildContext context, TeacherSettingsWebProvider provider) {
    return SizedBox(
                    ...
                    SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const SizedBox(width: 8),
                          Flexible(
                            child: Text("Reset Password", style: TextStyle(fontSize: 14), overflow: TextOverflow.ellipsis),
                          ),
                        ],
                      ),
                      ),
                          ...
                          child: provider.isLoading
                            ...
                            : Row(
                                ...
                                children: [
                                  ...
                                  const SizedBox(width: 8),
                                  Flexible(
                                    child: Text("Logout", style: TextStyle(fontSize: 14), overflow: TextOverflow.ellipsis),
                                  ),
                                ],
                              ),
                        ),
                          ...
                          child: provider.isLoading
                              ...
                              : Row(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Flexible(
                                      child: Text("Delete Account", style: TextStyle(color: Colors.red, fontSize: 14), overflow: TextOverflow.ellipsis),
                                    ),
                                  ],
                                ),
                        ),
  ...
  Widget _buildCheckboxRow(IconData icon, String title, bool value, ValueChanged<bool?> onChanged) {
    return Row(
      children: [
        ...
        Checkbox(value: value, onChanged: onChanged, activeColor: appGreen, side: BorderSide(color: appGreen)),
      ],
    );
  }
}
