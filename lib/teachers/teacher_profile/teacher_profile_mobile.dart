...
import 'teacher_profile_mobile_provider.dart';
...
class TeacherProfileMobile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => TeacherProfileMobileProvider(),
      child: Consumer<TeacherProfileMobileProvider>(
        builder: (context, provider, _) {
          if (provider.fullName.isEmpty && !provider.isLoading) {
  ...
  // Enhanced Profile Picture Section
  Widget _buildProfilePictureSection(BuildContext context, TeacherProfileMobileProvider provider) {
    return Column(
      children: [
        Stack(
          children: [
        ...
        Text(
          provider.fullName.isNotEmpty ? provider.fullName : 'Teacher',
  ...
  // Teacher Information Card
  Widget _buildInfoCard(BuildContext context, TeacherProfileMobileProvider provider) {
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(Icons.school_outlined, 'Degree', provider.degree),
          ],
        ),
      ),
    );
  ...
  // Statistics Card
  Widget _buildStatsCard(BuildContext context, TeacherProfileMobileProvider provider) {
    return Card(
      elevation: 2,
      color: Theme.of(context).cardColor,
      shadowColor: Theme.of(context).shadowColor,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.analytics_outlined, color: appGreen),
                const SizedBox(width: 8),
                const Text(
                  'Teaching Statistics',
                  style: TextStyle(
            ...
            _buildStatRow(
              ...
              'Assigned Students', 
              '${provider.assignedStudentsCount}',
            ),
          ],
        ),
      ),
  ...
  // Action Buttons
  Widget _buildActionButtons(BuildContext context, TeacherProfileMobileProvider provider) {
    return Column(
      children: [
        // Edit Profile Button
        SizedBox(
  ...
  // Show edit dialog
  void _showEditDialog(BuildContext context, TeacherProfileMobileProvider provider) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Center(child: const Text('Edit Profile', style: TextStyle(fontWeight: FontWeight.bold),)),
            ...
            child: Column(
              ...
              children: [
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelStyle: TextStyle(
                      color: Colors.grey, // Default label text color (before focus)
                    ),
                    labelText: 'Full Name',
                    focusColor: appGreen,
                ...
                TextFormField(
                  ...
                  validator: provider.validateDegree,
                ),
              ],
            ),
          ),
