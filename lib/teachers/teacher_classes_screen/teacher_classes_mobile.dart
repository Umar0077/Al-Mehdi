                    ...
                    const SizedBox(height: 16),
                       ...
                       child: ElevatedButton(
                         style: ElevatedButton.styleFrom(
                           ...
                           padding: EdgeInsets.symmetric(
                             horizontal: MediaQuery.of(context).size.width < 400 ? 24 : 32,
          ...
          trailing = Row(
            ...
            children: [
                 ...
                 onPressed: canJoin && jitsiRoom.isNotEmpty
                     ? () async {
                         try {
                           ...
                           Provider.of<TeacherClassesMobileProvider>(context, listen: false).loadClasses();
                         } catch (e) {
                           if (context.mounted) {
                 ...
                 style: OutlinedButton.styleFrom(
                   backgroundColor: canJoin && jitsiRoom.isNotEmpty
                       ? appGreen
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                   ...
                   padding: EdgeInsets.all(MediaQuery.of(context).size.width < 400 ? 8 : 6),
                   child: Icon(
                     Icons.class_, 
                     color: appGreen,
                 ...
                 SizedBox(width: MediaQuery.of(context).size.width < 400 ? 8 : 6),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
