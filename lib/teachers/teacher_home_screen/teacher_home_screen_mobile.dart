...
import 'teacher_home_screen_mobile_provider.dart';

class TeacherHomeScreenMobile extends StatelessWidget {
  const TeacherHomeScreenMobile({super.key});

  void joinJitsiMeeting(BuildContext context, String room, String? fullName) async {
  ...
  Widget _buildBody(BuildContext context, int selectedIndex, String? fullName) {
    switch (selectedIndex) {
      case 0:
        return _HomeTab(fullName: fullName, joinJitsiMeeting: (room) => joinJitsiMeeting(context, room, fullName));
      case 1:
      ...
      child: Consumer<TeacherHomeMobileProvider>(
        builder: (context, provider, _) {
          return Scaffold(
            ...
            body: _buildBody(context, provider.selectedIndex, provider.fullName),
                          ...
                          child: ListTile(
                            ...
                            subtitle: Builder(
                              builder: (context) {
                                ...
                                if (data['scheduledAt'] != null) {
                                  localDateTime = (data['scheduledAt'] as Timestamp).toDate().toLocal();
                                } else {
                            ...
                            trailing: OutlinedButton(
                              ...
                              style: OutlinedButton.styleFrom(
                                ...
                                backgroundColor: jitsiRoom.isNotEmpty
                                    ? appGreen
                                  ...
                                  isMissed
                                      ...
                                      : isCompleted
                                          ...
                                          : OutlinedButton(
                                            ...
                                            child: Text(teacherJoined ? 'Rejoin' : 'Join Class'),
                                      ),
                            ),
                          );
                        }).toList(),
