...
import '../../students/components/student_sidebar.dart';
...
import 'teacher_home_screen_web_provider.dart';
                                          ...
                                          children: [
                                            GestureDetector(
                                              onTap: () {
                                                ...
                                                Provider.of<TeacherHomeWebProvider>(
                                                  context,
                                                  listen: false,
                                                ).setSelectedIndex(2);
                                              },
                                            ...
                                            return FutureBuilder<DocumentSnapshot>(
                                              ...
                                              builder: (context, studentSnapshot) {
                                                ...
                                                if (studentSnapshot.hasData && studentSnapshot.data!.exists) {
                                                  studentName = studentSnapshot.data!['fullName'] ?? 'Student';
                                                }
                                                return _WebClassCard(
                                                  title: studentName,
                                                  time: classTime,
                                                  teacher: classDate,
                                                  text: teacherJoined ? 'Rejoin' : 'Join Class',
                                                  roomName: jitsiRoom,
