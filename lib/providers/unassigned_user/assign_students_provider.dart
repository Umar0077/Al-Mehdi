...
import '../../views/admin_dashboard/admin_home_view.dart';
  ...
  Future<void> assignStudent(
    ...
    await FirebaseFirestore.instance.runTransaction((transaction) async {
      ...
      final teacherRef = FirebaseFirestore.instance
          .collection('teachers')
          .doc(teacherUid);
      final unassignedStudentRef = FirebaseFirestore.instance
          .collection('unassigned_students')
          .doc(student['uid']);
      final unassignedTeacherRef = FirebaseFirestore.instance
