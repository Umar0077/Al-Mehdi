...
import 'student_home_screen_mobile_provider.dart';
                                  ...
                                  subtitle: Builder(
                                    builder: (context) {
                                      ...
                                      final displayTime = localDateTime != null
                                          ...
                                          : (classTime.isNotEmpty ? classTime : 'No time available');
                                      final displayDate = localDateTime != null
                                          ? DateFormat('yyyy-MM-dd').format(localDateTime)
                                          : (classDate.isNotEmpty ? classDate : 'No date available');
                                      return Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text(displayTime),
                              ...
                              child: ListTile(
                                ...
                                subtitle: Builder(
                                  builder: (context) {
                                    ...
                                    final displayTime = localDateTime != null
                                        ? TimeOfDay.fromDateTime(localDateTime).format(context)
                                        : (classTime ?? 'No time available');
                                    final displayDate = localDateTime != null
                                        ? DateFormat('yyyy-MM-dd').format(localDateTime)
                                        : (classDate ?? 'No date available');
                                    return Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text(displayTime),
                    ...
                    if (provider.joinableClass != null)
                      Padding(
                        ...
                        child: provider.hasJoined
                            ...
                            : ElevatedButton(
                                onPressed: provider.jitsiInitialized
