...
class OptimizedStudentChatWidget extends StatefulWidget {
  ...
  @override
  State<OptimizedStudentChatWidget> createState() => _OptimizedStudentChatWidgetState();
}

class _OptimizedStudentChatWidgetState extends State<OptimizedStudentChatWidget> {
  ...
  void _sendMessageFast() async {
    ...
    final provider = Provider.of<StudentChatMobileProvider>(context, listen: false);
                ...
                children: [
                  if (status == 'sending') ...[
                    ...
                    GestureDetector(
                      ...
                      child: const Text(
                        'Retry',
                        style: TextStyle(fontSize: 10, color: Colors.red, decoration: TextDecoration.underline),
                      ),
                    ),
                  ],
                ],
...
class OptimizedStudentChatConversationScreen extends StatelessWidget {
  ...
  const OptimizedStudentChatConversationScreen({
    required this.chat,
    super.key,
  });
          ...
          title: Row(
            children: [
              CircleAvatar(
                ...
                radius: 18,
                child: (chat['avatar'] ?? '').isEmpty ? Icon(Icons.person, color: Colors.white, size: 20) : null,
              ),
              const SizedBox(width: 8),
              Flexible(
                child: Text(
