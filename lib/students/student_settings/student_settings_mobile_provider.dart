...
class StudentSettingsMobileProvider extends ChangeNotifier {
  ...
  Future<void> _loadSelectedLanguage() async {
    try {
      ...
      final String? savedLanguage = prefs.getString('student_selected_language');
  ...
  Future<void> deleteAccount(BuildContext context) async {
    try {
      ...
      if (user != null) {
        ...
        final userRef = FirebaseFirestore.instance.collection('students').doc(userId);

        // Delete all subcollections
        final subcollections = ['messages', 'assignments', 'grades', 'attendance'];
      ...
      if (e.toString().contains('requires-recent-login')) {
        errorMessage = 'Please log in again before deleting your account for security reasons.';
