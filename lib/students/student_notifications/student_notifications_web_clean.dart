...
import 'student_notification_web_provider.dart';
...
class StudentNotificationWebView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => StudentNotificationWebProvider(),
      child: Consumer<StudentNotificationWebProvider>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final data = doc.data() as Map<String, dynamic>;
                              return _notificationCard(context, data, doc.id, provider);
                            },
                          );
                        },
                      ),
  ...
  Widget _filterAndSearch(BuildContext context, StudentNotificationWebProvider provider) {
    return Row(
      children: [
        Expanded(
          flex: 3,
          child: TextField(
            ...
            onChanged: (value) => provider.notifySearchChanged(),
  ...
  Widget _notificationCard(
    ...
    StudentNotificationWebProvider provider,
  ) {
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: isClassNotification 
            ? BorderSide(color: appGreen.withOpacity(0.3), width: 1.5)
            : BorderSide.none,
      ),
      child: Padding(
