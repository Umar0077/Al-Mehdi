...
import 'student_notification_mobile_provider.dart';
...
class StudentNotificationMobileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<StudentNotificationMobileProvider>(
      create: (_) => StudentNotificationMobileProvider(),
      child: Consumer<StudentNotificationMobileProvider>(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text(_formatTime(notif['timestamp'] as Timestamp?), style: const TextStyle(fontSize: 12, color: Colors.grey)),
              const Spacer(),
              if (notif['read'] == false)
                GestureDetector(
                  ...
                  child: const Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 4),
                      Text('Mark as Read', style: TextStyle(fontSize: 12, color: appGreen)),
                    ],
                  ),
                )
              else
                GestureDetector(
                  ...
                  child: const Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 4),
                      Text('Mark as Unread', style: TextStyle(fontSize: 12, color: appGreen)),
                    ],
                  ),
                ),
              ...
              GestureDetector(
                ...
                child: const Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 4),
                    Text('Delete', style: TextStyle(fontSize: 12, color: appRed)),
                  ],
                ),
              ),
            ],
  ...
  Future<void> _markAsRead(BuildContext context, String notificationId) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Error marking as read: $e')));
    }
  }
  ...
  Future<void> _markAsUnread(BuildContext context, String notificationId) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Error marking as unread: $e')));
    }
  }
