...
class RemoteConfigService {
  ...
  /// Check if mobile redirect is enabled
  bool get isMobileRedirectEnabled {
    try {
      return _remoteConfig?.getBool('enable_mobile_redirect') ?? true;
    } catch (e) {
      if (kDebugMode) {
        print('RemoteConfigService: Error getting enable_mobile_redirect: $e');
      }
      return true;
    }
  }
