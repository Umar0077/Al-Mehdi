import 'package:al_mehdi_online_school/components/mobile_redirect_wrapper.dart';
...
void main() async {
  ...
  if (kIsWeb) {
    ...
    // Optional: Log config status in debug mode
    if (kDebugMode) {
    ...
    return ValueListenableBuilder<ThemeMode>(
      ...
      builder: (_, mode, __) {
        return MaterialApp(
          ...
          themeMode: mode,
          home: MobileRedirectWrapper(child: const AppInitializer()),
        );
      },
    );
  }
