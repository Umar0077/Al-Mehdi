...
import 'total_users_provider.dart';
...
class _TotalUsersViewState extends State<_TotalUsersView> {
                                                ...
                                                child: Card(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      TextButton(
                                                        onPressed: () {
                                                          provider.toggleUserEnabled(index, !(user['enabled'] ?? false));
                                                        },
                                                        style: TextButton.styleFrom(
                                                          backgroundColor: (user['enabled'] ?? false) ? Colors.green : Colors.red,
  ...
  void _showUserDetailsPopup(BuildContext context, Map<String, dynamic> user) async {
    final provider = Provider.of<TotalUsersProvider>(context, listen: false);
    final userIndex = provider.filteredUsers.indexWhere((u) => u['id'] == user['id']);
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: CircleAvatar(
                            ...
                            child: userDetails['profilePictureUrl'].isEmpty
                                ? const Icon(
                                    Icons.person,
                                    size: 60,
                                    color: appGrey,
                        ...
                        StatefulBuilder(
                          builder: (context, setState) {
                            final currentUser = userIndex >= 0 ? provider.filteredUsers[userIndex] : user;
                            final isEnabled = currentUser['enabled'] ?? false;
                            
                            return TextButton(
                              onPressed: userIndex >= 0 ? () async {
                                await provider.toggleUserEnabled(userIndex, !isEnabled);
