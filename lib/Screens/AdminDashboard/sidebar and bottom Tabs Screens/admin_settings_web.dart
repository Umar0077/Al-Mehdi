...
class AdminSettingsScreenWeb extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<AdminSettingsProvider>(
      ...
      child: Consumer<AdminSettingsProvider>(builder: (context, provider, _) {
        return Scaffold(
  ...
  Widget _buildPreferenceCard(BuildContext context, AdminSettingsProvider provider) {
  ...
  Widget _buildAccountCard(BuildContext context, AdminSettingsProvider provider) {
    return SizedBox(
