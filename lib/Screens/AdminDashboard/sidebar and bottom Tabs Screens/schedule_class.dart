...
import 'schedule_class_provider.dart';
          ...
          builder: (context, provider, _) {
            ...
            Widget teacherDropdown = DropdownButtonFormField<String>(
              ...
              items: [
                DropdownMenuItem<String>(
                  value: null,
                  child: Text('Select Teacher', style: TextStyle(fontSize: 15, color: textColor)),
                ),
            ...
            if (provider.selectedTeacherId != null &&
              ...
              studentDropdown = DropdownButtonFormField<String>(
                ...
                items: [
                  DropdownMenuItem<String>(
                    value: null,
                    child: Text('Select Student', style: TextStyle(fontSize: 15, color: textColor)),
                  ),
            ...
            Widget scheduleTypeDropdown = DropdownButtonFormField<String>(
              ...
              items: [
                DropdownMenuItem<String>(
                  value: null,
                  child: Text('Select Schedule Type', style: TextStyle(fontSize: 15, color: textColor)),
                ),
            ...
            Widget durationDropdown = DropdownButtonFormField<String>(
              ...
              items: [
                DropdownMenuItem<String>(
                  value: null,
                  child: Text('Select Duration', style: TextStyle(fontSize: 15, color: textColor)),
                ),
            ...
            Widget customDaysSelection = provider.selectedScheduleType == 'custom_days'
                ? Container(
                        ...
                        Wrap(
                          ...
                          children: provider.daysOptions.map((day) {
                            ...
                            return FilterChip(
                              ...
                              selected: isSelected,
                              onSelected: (selected) {
                                provider.onDaySelectionChanged(day['value']!, selected);
                              },
                              selectedColor: appGreen,
                              checkmarkColor: Colors.white,
                              backgroundColor: appLightGreen,
                              side: BorderSide(color: isSelected ? appGreen : Colors.grey),
                            );
                          }).toList(),
                        ),
                      ],
            ...
            Widget scheduleButton = SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: provider.isScheduling ? null : () => provider.scheduleClass(context),
                child: Padding(
                  padding: const EdgeInsets.symmetric(vertical: 4.0),
                  child: provider.isScheduling
                      ? const Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 12),
                            Text('Scheduling...', style: TextStyle(fontSize: 16)),
                          ],
                        )
                                    ...
                                    children: [
                                      Expanded(
                                        child: DropdownButtonFormField<String>(
                                          value: provider.filterTeacherId,
                                          dropdownColor: dropdownColor,
                                          icon: const Icon(Icons.arrow_drop_down, color: appGreen),
                                          decoration: InputDecoration(
                                          ...
                                          items: [
                                            DropdownMenuItem<String>(
                                              value: null,
                                              child: Text('All Teachers', style: TextStyle(fontSize: 15, color: textColor)),
                                            ),
                                            ...provider.teachers.map<DropdownMenuItem<String>>(
                                              (t) => DropdownMenuItem<String>(
                                                value: t['uid'] as String,
                                                child: Text(
                                                  t['name'] as String,
                                          ...
                                          onChanged: (val) => provider.setFilterTeacherId(val),
                                        ),
                                      ),
                                      const SizedBox(width: 25),
                                      Expanded(
                                        child: DropdownButtonFormField<String>(
                                          value: provider.filterStudentId,
                                          dropdownColor: dropdownColor,
                                          icon: const Icon(Icons.arrow_drop_down, color: appGreen),
                                          decoration: InputDecoration(
                                          ...
                                          items: [
                                            DropdownMenuItem<String>(
                                              value: null,
                                              child: Text('All Students', style: TextStyle(fontSize: 15, color: textColor)),
                                            ),
                                            ...provider.filterStudents.map<DropdownMenuItem<String>>(
                                              (s) => DropdownMenuItem<String>(
                                                value: s['uid'] as String,
                                                child: Text(
                                                  s['name'] as String,
                                          ...
                                          onChanged: (val) => provider.setFilterStudentId(val),
                                        ),
                                      ),
                                    ],
                                  ),
                                    ...
                                    children: [
                                      Expanded(
                                        child: TextFields(
                                          ...
                                          icon: Icons.calendar_today,
                                          isDatePicker: true,
                                          controller: TextEditingController(text: provider.filterStartDate ?? ''),
                                          onChanged: (val) => provider.setFilterStartDate(val.isEmpty ? null : val),
                                        ),
                                      ),
                                      const SizedBox(width: 25),
                                      Expanded(
                                        child: TextFields(
                                          ...
                                          icon: Icons.calendar_today,
                                          isDatePicker: true,
                                          controller: TextEditingController(text: provider.filterEndDate ?? ''),
                                          onChanged: (val) => provider.setFilterEndDate(val.isEmpty ? null : val),
                                        ),
                                      ),
                                    ],
                                  ),
                                    ...
                                    children: [
                                      ...
                                      if (provider.filteredScheduledClasses.isNotEmpty)
                                        ElevatedButton(
                                          ...
                                          onPressed: () => provider.showCancelAllClassesDialog(context),
                                          child: Text('Cancel All (${provider.filteredScheduledClasses.length})'),
                                        ),
                                    ],
                                  ),
                                  const SizedBox(height: 24),
                                  if (provider.filteredScheduledClasses.isNotEmpty) ...[
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ElevatedButton(
                                                ...
                                                onPressed: () => provider.showCancelClassDialog(context, classData),
                                                child: const Text(
                                                  'Cancel',
                                    ...
                                    if (provider.filteredScheduledClasses.length > 10)
                                      Center(
                                        child: IconButton(
                                          icon: Icon(
                                            showAllFilteredClasses ? Icons.keyboard_arrow_up : Icons.keyboard_arrow_down,
                                            size: 32,
                                          ),
                                          tooltip: showAllFilteredClasses ? 'Show less' : 'Show more',
                                          onPressed: () {
                                            setState(() {
                                              showAllFilteredClasses = !showAllFilteredClasses;
                                            });
                                          },
                                        ),
                                      ),
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            items: [
                              const DropdownMenuItem<String>(
                                value: null,
                                child: Text('All Teachers', style: TextStyle(fontSize: 15,)),
                              ),
                              ...provider.teachers.map<DropdownMenuItem<String>>(
                                (t) => DropdownMenuItem<String>(
                                  value: t['uid'] as String,
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            items: [
                              const DropdownMenuItem<String>(
                                value: null,
                                child: Text('All Students', style: TextStyle(fontSize: 15)),
                              ),
                              ...provider.filterStudents.map<DropdownMenuItem<String>>(
                                (s) => DropdownMenuItem<String>(
                                  value: s['uid'] as String,
