                ...
                return Scaffold(
                  ...
                  body: Row(
                    children: [
                                          ...
                                          child: DropdownButtonHideUnderline(
                                            child: DropdownButton<String>(
                                              ...
                                              onChanged: (val) async {
                                                ...
                                                if (val != null) {
                                                  await provider.loadStudentsForTeacher(val);
                                                }
                                              },
                                            ),
                                          ),
                                                  ...
                                                  child: DropdownButtonHideUnderline(
                                                    child: DropdownButton<String>(
                                                      ...
                                                      onChanged: (val) async {
                                                        ...
                                                        if (val != null) {
                                                          await provider.loadTeachersForStudent(val);
                                                        }
                                                      },
                                                    ),
                                                  ),
                                          ...
                                          : ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              ...
                                              return Container(
                                                decoration: BoxDecoration(
                                                  color:
                                                      provider.selectedChatIndex == index
                                                ...
                                                child: ChatListTile(
                                                  ...
                                                  selected:
                                                      provider.selectedChatIndex == index,
                                                  onTap:
                                                      () => provider.setSelectedChatIndex(index),
                                                ),
                                              );
                                            },
                                          ),
                      ...
                      Expanded(
                        child:
                            provider.selectedChatIndex == null || filteredRooms.isEmpty
                                ? const Center(
                                  child: Text(
                                ...
                                : AdminChatConversation(
                                  chatRoomId: filteredRooms[provider.selectedChatIndex!]['id'],
                                  studentName:
                                      filteredRooms[provider.selectedChatIndex!]['studentName'],
                                  teacherName:
                                      filteredRooms[provider.selectedChatIndex!]['teacherName'],
                                  studentId:
                                      filteredRooms[provider.selectedChatIndex!]['studentId'],
                                  teacherId:
                                      filteredRooms[provider.selectedChatIndex!]['teacherId'],
                                ),
                      ),
                    ],
                  ),
                                            ...
                                            child: DropdownButtonHideUnderline(
                                              child: DropdownButton<String>(
                                                ...
                                                onChanged: (val) async {
                                                  provider.setSelectedStudentId(val);
                                                  if (val != null) {
                                                    await provider.loadTeachersForStudent(
                                                      val,
                                                    );
                                                  }
                                                },
    ...
    return Material(
      color:
          selected
              ...
              : Colors.transparent,
      child: ListTile(
        leading: avatar != null ? CircleAvatar(
